...
player forceAddUniform "Alpine_Crye_Camo";
player addVest ([_currentVest, "Arctic"] call compile preprocessFileLineNumbers "loadouts\switch\findVest.sqf");
player addBackpack ([_currentBackpack, "Arctic"] call compile preprocessFileLineNumbers "loadouts\switch\findBackpack.sqf");
player addHeadgear ([_currentHeadgear, "Arctic"] call compile preprocessFileLineNumbers "loadouts\switch\findHeadgear.sqf");
player addGoggles ([_currentGoggles, "Arctic"] call compile preprocessFileLineNumbers "loadouts\switch\findFace.sqf");
