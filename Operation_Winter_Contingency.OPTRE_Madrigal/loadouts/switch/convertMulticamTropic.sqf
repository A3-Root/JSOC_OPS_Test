...
player forceAddUniform "VSM_MulticamTropic_Crye_SS_Camo";
player addVest ([_currentVest, "MulticamTropic"] call compile preprocessFileLineNumbers "loadouts\switch\findVest.sqf");
player addBackpack ([_currentBackpack, "MulticamTropic"] call compile preprocessFileLineNumbers "loadouts\switch\findBackpack.sqf");
player addHeadgear ([_currentHeadgear, "MulticamTropic"] call compile preprocessFileLineNumbers "loadouts\switch\findHeadgear.sqf");
player addGoggles ([_currentGoggles, "MulticamTropic"] call compile preprocessFileLineNumbers "loadouts\switch\findFace.sqf");
