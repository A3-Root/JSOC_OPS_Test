...
ACE_player forceAddUniform "VSM_Multicam_Crye_grey_shirt_Camo";
ACE_player addVest "VSM_FAPC_Operator_OGA_OD";
ACE_player addBackpack "VSM_OGA_OD_Backpack_Compact";
