comment "Exported from Arsenal by [Spc.] Mujad";
...
ACE_player addHandgunItem "UGL_FlareCIR_F";

comment "Add containers";
ACE_player forceAddUniform "black_Crye_Camo";
ACE_player addVest "dr_BLKlbt_op";
ACE_player addBackpack "jsoc_ilbe_dd_black";
...
for "_i" from 1 to 8 do {ACE_player addItemToBackpack "UGL_FlareCIR_F";};
ACE_player addHeadgear "BLK2_opscore";
