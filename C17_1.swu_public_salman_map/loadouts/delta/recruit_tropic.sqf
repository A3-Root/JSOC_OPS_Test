...
ACE_player forceAddUniform "VSM_MulticamTropic_Crye_SS_grey_shirt_Camo";
ACE_player addVest "VSM_FAPC_Operator_MulticamTropic";
ACE_player addHeadgear "VSM_MulticamTropic_OPS";

comment "Add weapons";
ACE_player addWeapon "rhs_weap_m4a1_carryhandle";
...
for "_i" from 1 to 10 do {ACE_player addItemToUniform "ACE_fieldDressing";}; for "_i" from 1 to 10 do {ACE_player addItemToUniform "ACE_packingBandage";};
