...
player forceAddUniform "VSM_Multicam_Crye_SS_Camo";
player addVest ([_currentVest, "Multicam"] call compile preprocessFileLineNumbers "loadouts\switch\findVest.sqf");
player addBackpack ([_currentBackpack, "Multicam"] call compile preprocessFileLineNumbers "loadouts\switch\findBackpack.sqf");
player addHeadgear ([_currentHeadgear, "Multicam"] call compile preprocessFileLineNumbers "loadouts\switch\findHeadgear.sqf");
player addGoggles ([_currentGoggles, "Multicam"] call compile preprocessFileLineNumbers "loadouts\switch\findFace.sqf");
